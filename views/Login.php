...
<head>
    ...
    <link rel="stylesheet" href="/trabalho-ads-dsw-frontend-main/public/styles/Login.css">
...
<body>
    <div class="login-container">
        ...
        <h3>Login - SisGer7</h3>
        <form action="/trabalho-ads-dsw-frontend/index.php?action=login" method="post">
