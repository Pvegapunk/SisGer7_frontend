    ...
    public function index()
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($usuario && $password === $usuario['senha']) {
                ...
                header("Location: /trabalho-ads-dsw-frontend-main/views/PaginaIntermediaria.php"); 
                exit;
            } else {
                echo "<script>alert('Senha incorreta. Tente novamente.');</script>";
                header("Location: /trabalho-ads-dsw-frontend-main/index.php");
                exit;
            }
        } else {
            require_once $_SERVER["DOCUMENT_ROOT"] . '/trabalho-ads-dsw-frontend-main/views/Login.php';
        }
    }
}
?>
